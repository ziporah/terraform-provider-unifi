	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"ruleset": {
				Type:         schema.TypeString,
				Required:     true,
				ValidateFunc: validation.StringInSlice([]string{"WAN_IN", "WAN_OUT", "WAN_LOCAL", "LAN_IN", "LAN_OUT", "LAN_LOCAL", "GUEST_IN", "GUEST_OUT", "GUEST_LOCAL", "WANv6_IN", "WANv6_OUT", "WANv6_LOCAL", "LANv6_IN", "LANv6_OUT", "LANv6_LOCAL", "GUESTv6_IN", "GUESTv6_OUT", "GUESTv6_LOCAL"}),
			},
			"rule_index": {
				Type:     schema.TypeInt,
				Required: true,
...
func resourceFirewallRuleCreate(d *schema.ResourceData, meta interface{}) error {
	...
	resp, err := c.c.CreateFirewallRule(c.site, req)
	if err != nil {
		return err
	}
...
func resourceFirewallRuleRead(d *schema.ResourceData, meta interface{}) error {
	...
	resp, err := c.c.GetFirewallRule(c.site, id)
...
func resourceFirewallRuleUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	resp, err := c.c.UpdateFirewallRule(c.site, req)
	if err != nil {
		return err
	}
...
func resourceFirewallRuleDelete(d *schema.ResourceData, meta interface{}) error {
	...
	err := c.c.DeleteFirewallRule(c.site, id)
	if _, ok := err.(*unifi.NotFoundError); ok {
		return nil
	}
	return err
